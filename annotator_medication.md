<h3 id="medication">Medications</h3>

Identifies information that is related to medications such as drug name, dosage value, frequency and so forth.
...
<table>
<caption>aci.MedicationInd</caption>
